        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="/views/productos.php">Productos</a></li>
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="/views/cart.php">Carrito</a></li>
                    <?php if (isset($_SESSION['validado']) ?? $_SESSION['validado'] == TRUE) { ?>
                        <li class="nav-item"><a class="nav-link" href="/client/perfil.php">Mi perfil</a></li>
